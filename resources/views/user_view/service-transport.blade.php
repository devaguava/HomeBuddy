            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="container-fluid p-0">
                        <img class="img-fluid" src="{{ asset('assets') }}/img/angkut4.jpg" alt=""
                    ...
                    <div class="team-item rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <span style="display: block; margin-bottom: 10px;">Goods Transportation Expert</span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="container-fluid p-0">
                        <img class="img-fluid" src="{{ asset('assets') }}/img/jasa pengangkutan.jpeg" alt=""
                            style="width: 100%; height: 350px; object-fit: cover;">
                    </div>
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="container-fluid p-0">
                        <img class="img-fluid" src="{{ asset('assets') }}/img/angkut5.png" alt=""
                            style="width: 100%; height: 350px; object-fit: cover;">
                    </div>
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
