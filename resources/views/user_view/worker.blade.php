        ...
        <div class="container">
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
                            ...
                            <div class="team-social w-25">
                                <div class="text-center">
                                    ...
                                    <span style="display: block; margin-top: 10px; font-size: 14px;">Contact</span>
                                </div>
                        ...
                        <div class="p-4">
                            <h5>Anto</h5>
                            <h3 style="color:lightsalmon">Rp100.000</h3>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
                            <img class="img-fluid w-75" src="{{ asset('assets') }}/img/angkut4.jpg" alt=""
                                style="width: 100%; height: 350px; object-fit: cover;">
                            <div class="team-social w-25">
                                <div class="text-center">
                                    <a class="btn btn-lg-square btn-outline-primary rounded-circle mt-3"
                        ...
                        <div class="p-4">
                            <h5>Rino</h5>
                            <h3 style="color:lightsalmon">Rp190.000</h3>
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
                            <img class="img-fluid w-75" src="{{ asset('assets') }}/img/perbaikan6.jpg" alt=""
                                style="width: 100%; height: 350px; object-fit: cover;">
                            <div class="team-social w-25">
                                <div class="text-center">
                                    <a class="btn btn-lg-square btn-outline-primary rounded-circle mt-3"
                        ...
                        <div class="p-4">
                            <h5>Joko</h5>
                            <h3 style="color:lightsalmon">Rp95.000</h3>
                            <span>House Refinement Expert</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
                            <img class="img-fluid w-75" src="{{ asset('assets') }}/img/pembersihan6.jpg"
                                alt="" style="width: 100%; height: 350px; object-fit: cover;">
                            <div class="team-social w-25">
                                <div class="text-center">
                                    <a class="btn btn-lg-square btn-outline-primary rounded-circle mt-3"
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            <h5>Jet</h5>
                            <h3 style="color:lightsalmon">Rp250.000</h3>
                            <span>Goods Transportation Expert</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
                            <img class="img-fluid w-75" src="{{ asset('assets') }}/img/perbaikan5.jpg"
                                alt="" style="width: 100%; height: 350px; object-fit: cover;">
                            <div class="team-social w-25">
                                <div class="text-center">
                                    <a class="btn btn-lg-square btn-outline-primary rounded-circle mt-3"
                        ...
                        <div class="p-4">
                            <h5>Hans</h5>
                            <h3 style="color:lightsalmon">Rp200.000</h3>
                            <span>House Refinement Expert</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
                            <img class="img-fluid w-75" src="{{ asset('assets') }}/img/pembersihan5.jpg"
                                alt="" style="width: 100%; height: 350px; object-fit: cover;">
                            <div class="team-social w-25">
                                <div class="text-center">
                                    <a class="btn btn-lg-square btn-outline-primary rounded-circle mt-3"
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="d-flex">
                            <img class="img-fluid w-75" src="{{ asset('assets') }}/img/angkut5.png" alt=""
                                style="width: 100%; height: 350px; object-fit: cover;">
                            <div class="team-social w-25">
                                <div class="text-center">
                                    <a class="btn btn-lg-square btn-outline-primary rounded-circle mt-3"
